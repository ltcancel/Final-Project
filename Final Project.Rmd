...
#select subset  
happy2019 <- select(happy2019,Overall.rank,Country.or.region,Score,Healthy.life.expectancy,Generosity,year)
head(happy2019)

happy2018 <- select(happy2018,Overall.rank,Country.or.region,Score,Healthy.life.expectancy,Generosity,year)
